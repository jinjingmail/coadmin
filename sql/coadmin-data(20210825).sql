...
insert  into `code_column_config`(`id`,`table_name`,`column_name`,`column_type`,`dict_name`,`extra`,`form_show`,`form_type`,`key_type`,`list_show`,`not_null`,`query_type`,`remark`,`date_annotation`) values (1347073476186038273,'test_person','name','varchar',NULL,'','','Input','','','','Like','姓名',NULL);
insert  into `code_column_config`(`id`,`table_name`,`column_name`,`column_type`,`dict_name`,`extra`,`form_show`,`form_type`,`key_type`,`list_show`,`not_null`,`query_type`,`remark`,`date_annotation`) values (1347073476186038274,'test_person','gender','varchar','gender','','','Radio','','','','=','性别',NULL);
insert  into `code_column_config`(`id`,`table_name`,`column_name`,`column_type`,`dict_name`,`extra`,`form_show`,`form_type`,`key_type`,`list_show`,`not_null`,`query_type`,`remark`,`date_annotation`) values (1347073476186038275,'test_person','birthday','date',NULL,'','','Date','','','','=','出生日期',NULL);
insert  into `code_column_config`(`id`,`table_name`,`column_name`,`column_type`,`dict_name`,`extra`,`form_show`,`form_type`,`key_type`,`list_show`,`not_null`,`query_type`,`remark`,`date_annotation`) values (1347073476186038276,'test_person','create_time','datetime',NULL,'','','showOnly','','','\0','BetWeen','创建时间','CreationTimestamp');
insert  into `code_column_config`(`id`,`table_name`,`column_name`,`column_type`,`dict_name`,`extra`,`form_show`,`form_type`,`key_type`,`list_show`,`not_null`,`query_type`,`remark`,`date_annotation`) values (1347073476186038277,'test_person','create_by','varchar',NULL,'','',NULL,'','\0','\0',NULL,'创建人','CreationTimestamp');
insert  into `code_column_config`(`id`,`table_name`,`column_name`,`column_type`,`dict_name`,`extra`,`form_show`,`form_type`,`key_type`,`list_show`,`not_null`,`query_type`,`remark`,`date_annotation`) values (1347073476248952834,'test_person','update_time','datetime',NULL,'','',NULL,'','\0','\0',NULL,'修改时间','UpdateTimestamp');
insert  into `code_column_config`(`id`,`table_name`,`column_name`,`column_type`,`dict_name`,`extra`,`form_show`,`form_type`,`key_type`,`list_show`,`not_null`,`query_type`,`remark`,`date_annotation`) values (1347073476248952835,'test_person','update_by','varchar',NULL,'','',NULL,'','','\0',NULL,'修改人','UpdateTimestamp');
insert  into `code_column_config`(`id`,`table_name`,`column_name`,`column_type`,`dict_name`,`extra`,`form_show`,`form_type`,`key_type`,`list_show`,`not_null`,`query_type`,`remark`,`date_annotation`) values (1347086544236400642,'test_person','remarks','varchar',NULL,'','','Textarea','','','\0',NULL,'备注',NULL);
insert  into `code_column_config`(`id`,`table_name`,`column_name`,`column_type`,`dict_name`,`extra`,`form_show`,`form_type`,`key_type`,`list_show`,`not_null`,`query_type`,`remark`,`date_annotation`) values (1429253331278860290,'test_person','mysql_engine','tinyint','mysql_engine','','','Select','','','\0','=','测试enum',NULL);

/*Data for the table `code_gen_config` */

insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (1,'sys_user','jinjin2','\0','coadmin-system',NULL,'com.gitee.coadmin.modules.mybatis','D:\\lvjinhua\\work\\demo\\coadmin\\coadmin-system\\src\\main\\java\\me\\zhengjie\\modules\\mybatis\\user','non\\','sys_','系统用户',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (2,'sys_dict','jinjin','\0','eladmin-system',NULL,'me.zhengjie.modules.system','D:\\lvjinhua\\work\\demo\\eladmin\\eladmin-system\\src\\main\\java\\me\\zhengjie\\modules\\mybatis','D:\\lvjinhua\\work\\demo\\eladmin\\eladmin-system\\src\\api','sys_','字典',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (3,'sys_dict_detail','jinjin22','\0','eladmin-system',NULL,'me.zhengjie.modules.system','xxx','xxx\\','sys_','字典值',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (4,'sys_role','jinjin','\0','eladmin-system',NULL,'me.zhengjie.modules.mybatis','xxx','xxx\\','sys_','角色',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (5,'sys_dept','jinjin','\0','eladmin-system',NULL,'me.zhengjie.modules.mybatis','xxx','xxx\\','sys_','部门',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (6,'sys_job','jinjin','\0','eladmin-system',NULL,'me.zhengjie.modules.mybatis','xxx','xxx\\','sys_','岗位',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (7,'sys_menu','jinjin','\0','eladmin-system',NULL,'me.zhengjie.modules.mybatis','xxx','xxx\\','sys_','菜单',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (8,'tool_email_config','jinjin','\0','eladmin-tools',NULL,'me.zhengjie.mybatis','xxx','xxx\\','tool_','邮箱配置',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (9,'tool_local_storage','jinjin','\0','eladmin-tools',NULL,'me.zhengjie.mybatis','xxx','xxx\\','tool_','本地存储',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (10,'tool_qiniu_config','jinjin','\0','eladmin-tools',NULL,'me.zhengjie.mybatis','xxx','xxx\\','tool','七牛云配置',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (11,'tool_qiniu_content','jinjin','\0','eladmin-tools',NULL,'me.zhengjie.mybatis','xxx','xxx\\','tool_','七牛云内容',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (12,'tool_alipay_config','jinjin','\0','eladmin-tools',NULL,'me.zhengjie.mybatis','xxx','xxx\\','tool_','阿里云配置',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (13,'sys_log','jinjin','\0','eladmin-logging',NULL,'me.zhengjie.mybatis','xxx','xxx\\','sys_','日志',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (14,'sys_quartz_job','jinjin','\0','eladmin-system',NULL,'me.zhengjie.modules.quartz.mybatis','xxx','xxx\\','sys_','定时任务',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (15,'sys_quartz_log','jinjin','\0','eladmin-system',NULL,'me.zhengjie.modules.quartz.mybatis','xxx','xxx\\','sys_','定时任务日志',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (16,'mnt_database','jinjin','\0','eladmin-system',NULL,'me.zhengjie.modules.mnt.mybatis','xxx','xxx\\','mnt_','数据库管理',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (17,'mnt_app','jinjin','\0','eladmin-system',NULL,'me.zhengjie.modules.mnt.mybatis','xxx','xxx\\','mnt_','应用管理',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (18,'mnt_server','jinjin','\0','eladmin-system',NULL,'me.zhengjie.modules.mnt.mybatis','xxx','xxx\\','mnt_','服务器管理',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (19,'mnt_deploy_history','jinjin','\0','eladmin-system',NULL,'me.zhengjie.modules.mnt.mybatis','xxx','xxx\\','mnt_','部署历史',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (20,'mnt_deploy','jinjin','\0','eladmin-system',NULL,'me.zhengjie.modules.mnt.mybatis','xxx','xxx\\','mnt_','部署管理',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (21,'test_table1','jinjin','','coadmin-system',NULL,'com.gitee.coadmin.modules.test','xxx','xxx\\','test_','测试',NULL);
insert  into `code_gen_config`(`id`,`table_name`,`author`,`cover`,`module_name`,`sub_module_name`,`pack`,`path`,`api_path`,`prefix`,`api_alias`,`menu_pid`) values (1347075276712665089,'test_person','jinjin','','coadmin-core','test','com.gitee.coadmin.modules.test','D:\\lvjinhua\\work\\admin\\coadmin-web-quasar\\src\\pages','D:\\lvjinhua\\work\\admin\\coadmin-web-quasar\\src\\api','','演示',121);
...
insert  into `sys_dept`(`id`,`pid`,`name`,`name_letter`,`sort`,`dept_code`,`tree_pids`,`tree_names`,`tree_names_letter`,`tree_sorts`,`tree_level`,`tree_leaf`,`enabled`,`create_by`,`update_by`,`create_time`,`update_time`) values (5,0,'运维部','ywb',3,NULL,'/','/运维部','/ywb','/00003',0,'\0','','admin','admin','2019-03-25 09:20:44','2021-07-29 23:23:18');
insert  into `sys_dept`(`id`,`pid`,`name`,`name_letter`,`sort`,`dept_code`,`tree_pids`,`tree_names`,`tree_names_letter`,`tree_sorts`,`tree_level`,`tree_leaf`,`enabled`,`create_by`,`update_by`,`create_time`,`update_time`) values (6,8,'测试部2','csb2',2,NULL,'/8/','/华北分部啊/测试部2','/hbfba/csb2','/00001/00002',1,'','\0','admin','admin','2019-03-25 09:52:18','2021-08-25 07:06:47');
...
insert  into `sys_dept`(`id`,`pid`,`name`,`name_letter`,`sort`,`dept_code`,`tree_pids`,`tree_names`,`tree_names_letter`,`tree_sorts`,`tree_level`,`tree_leaf`,`enabled`,`create_by`,`update_by`,`create_time`,`update_time`) values (8,0,'华北分部啊','hbfba',1,NULL,'/','/华北分部啊','/hbfba','/00001',0,'\0','','admin','admin','2019-03-25 11:04:53','2021-08-25 07:06:47');
insert  into `sys_dept`(`id`,`pid`,`name`,`name_letter`,`sort`,`dept_code`,`tree_pids`,`tree_names`,`tree_names_letter`,`tree_sorts`,`tree_level`,`tree_leaf`,`enabled`,`create_by`,`update_by`,`create_time`,`update_time`) values (19,5,'运维一组','ywyz',999,NULL,'/5/','/运维部/运维一组','/ywb/ywyz','/00003/00999',1,'','','admin','admin','2020-10-06 18:25:01','2021-07-29 23:23:18');
...
insert  into `sys_dept`(`id`,`pid`,`name`,`name_letter`,`sort`,`dept_code`,`tree_pids`,`tree_names`,`tree_names_letter`,`tree_sorts`,`tree_level`,`tree_leaf`,`enabled`,`create_by`,`update_by`,`create_time`,`update_time`) values (35,0,'东北公司','dbgs',999,NULL,'/','/东北公司','/dbgs','/00999',0,'\0','','admin','admin','2020-10-09 19:52:45','2021-07-24 18:43:36');
insert  into `sys_dept`(`id`,`pid`,`name`,`name_letter`,`sort`,`dept_code`,`tree_pids`,`tree_names`,`tree_names_letter`,`tree_sorts`,`tree_level`,`tree_leaf`,`enabled`,`create_by`,`update_by`,`create_time`,`update_time`) values (36,35,'吉林','jl',5,NULL,'/35/','/东北公司/吉林','/dbgs/jl','/00999/00005',1,'\0','','admin','admin','2020-10-09 19:55:18','2021-07-24 18:43:36');
insert  into `sys_dept`(`id`,`pid`,`name`,`name_letter`,`sort`,`dept_code`,`tree_pids`,`tree_names`,`tree_names_letter`,`tree_sorts`,`tree_level`,`tree_leaf`,`enabled`,`create_by`,`update_by`,`create_time`,`update_time`) values (37,36,'运维部吉林','ywbjl',333,NULL,'/35/36/','/东北公司/吉林/运维部吉林','/dbgs/jl/ywbjl','/00999/00005/00333',2,'','','admin','admin','2020-10-09 19:58:58','2021-07-24 18:43:36');
insert  into `sys_dept`(`id`,`pid`,`name`,`name_letter`,`sort`,`dept_code`,`tree_pids`,`tree_names`,`tree_names_letter`,`tree_sorts`,`tree_level`,`tree_leaf`,`enabled`,`create_by`,`update_by`,`create_time`,`update_time`) values (38,36,'财务部吉林','cwbjl',999,NULL,'/35/36/','/东北公司/吉林/财务部吉林','/dbgs/jl/cwbjl','/00999/00005/00999',2,'','','admin','admin','2020-10-09 20:31:36','2021-07-24 18:43:36');
...
insert  into `sys_dept`(`id`,`pid`,`name`,`name_letter`,`sort`,`dept_code`,`tree_pids`,`tree_names`,`tree_names_letter`,`tree_sorts`,`tree_level`,`tree_leaf`,`enabled`,`create_by`,`update_by`,`create_time`,`update_time`) values (46,5,'运维二组','ywez',999,NULL,'/5/','/运维部/运维二组','/ywb/ywez','/00003/00999',1,'','','admin','admin','2020-11-07 16:46:18','2021-07-29 23:23:18');
insert  into `sys_dept`(`id`,`pid`,`name`,`name_letter`,`sort`,`dept_code`,`tree_pids`,`tree_names`,`tree_names_letter`,`tree_sorts`,`tree_level`,`tree_leaf`,`enabled`,`create_by`,`update_by`,`create_time`,`update_time`) values (48,8,'研发部','yfb',3,NULL,'/8/','/华北分部啊/研发部','/hbfba/yfb','/00001/00003',1,'','','admin','admin','2020-11-07 16:59:17','2021-08-25 07:06:47');
insert  into `sys_dept`(`id`,`pid`,`name`,`name_letter`,`sort`,`dept_code`,`tree_pids`,`tree_names`,`tree_names_letter`,`tree_sorts`,`tree_level`,`tree_leaf`,`enabled`,`create_by`,`update_by`,`create_time`,`update_time`) values (49,0,'西北','xb',444,NULL,'/','/西北','/xb','/00444',0,'','','admin','admin','2020-11-07 17:50:57','2021-07-24 18:43:31');
...
insert  into `sys_dept`(`id`,`pid`,`name`,`name_letter`,`sort`,`dept_code`,`tree_pids`,`tree_names`,`tree_names_letter`,`tree_sorts`,`tree_level`,`tree_leaf`,`enabled`,`create_by`,`update_by`,`create_time`,`update_time`) values (52,8,'财务部2','cwb2',13,NULL,'/8/','/华北分部啊/财务部2','/hbfba/cwb2','/00001/00013',1,'','','admin','admin','2020-12-26 11:39:51','2021-08-25 07:06:47');
insert  into `sys_dept`(`id`,`pid`,`name`,`name_letter`,`sort`,`dept_code`,`tree_pids`,`tree_names`,`tree_names_letter`,`tree_sorts`,`tree_level`,`tree_leaf`,`enabled`,`create_by`,`update_by`,`create_time`,`update_time`) values (53,8,'总裁办','zcb',12,NULL,'/8/','/华北分部啊/总裁办','/hbfba/zcb','/00001/00012',1,'','\0','admin','admin','2020-12-26 14:35:17','2021-08-25 07:06:47');
...
insert  into `sys_dict`(`id`,`name`,`description`,`create_by`,`update_by`,`create_time`,`update_time`) values (8,'jobs_status','定时任务状态','demo','admin','2021-01-03 21:36:34','2021-07-24 18:43:00');
insert  into `sys_dict`(`id`,`name`,`description`,`create_by`,`update_by`,`create_time`,`update_time`) values (9,'mysql_engine','MySQL存储引擎','admin','admin','2021-08-22 09:28:42','2021-08-22 09:28:42');
...
insert  into `sys_dict_detail`(`id`,`dict_id`,`label`,`value`,`sort`,`create_by`,`update_by`,`create_time`,`update_time`) values (13,7,'男','男',10,'admin','admin','2020-12-31 10:30:22','2021-07-19 22:57:30');
insert  into `sys_dict_detail`(`id`,`dict_id`,`label`,`value`,`sort`,`create_by`,`update_by`,`create_time`,`update_time`) values (14,7,'女','女',20,'admin','admin','2020-12-31 10:30:53','2021-07-24 18:42:55');
insert  into `sys_dict_detail`(`id`,`dict_id`,`label`,`value`,`sort`,`create_by`,`update_by`,`create_time`,`update_time`) values (15,8,'运行中','true',10,'demo','admin','2021-01-03 21:36:56','2021-08-22 09:55:29');
...
insert  into `sys_dict_detail`(`id`,`dict_id`,`label`,`value`,`sort`,`create_by`,`update_by`,`create_time`,`update_time`) values (18,9,'InnoDB','10',10,'admin','admin','2021-08-22 09:29:06','2021-08-22 09:55:22');
insert  into `sys_dict_detail`(`id`,`dict_id`,`label`,`value`,`sort`,`create_by`,`update_by`,`create_time`,`update_time`) values (19,9,'MyISAM','20',20,'admin','admin','2021-08-22 09:30:44','2021-08-22 10:09:05');
insert  into `sys_dict_detail`(`id`,`dict_id`,`label`,`value`,`sort`,`create_by`,`update_by`,`create_time`,`update_time`) values (20,9,'Memory','30',30,'admin','admin','2021-08-22 09:30:57','2021-08-22 09:30:57');

/*Data for the table `sys_job` */

insert  into `sys_job`(`id`,`name`,`enabled`,`sort`,`create_by`,`update_by`,`create_time`,`update_time`) values (8,'人事专员','',3,NULL,'admin','2019-03-29 14:52:28','2021-08-25 20:59:15');
insert  into `sys_job`(`id`,`name`,`enabled`,`sort`,`create_by`,`update_by`,`create_time`,`update_time`) values (10,'产品经理','',4,NULL,'admin','2019-03-29 14:55:51','2021-07-24 15:21:03');
insert  into `sys_job`(`id`,`name`,`enabled`,`sort`,`create_by`,`update_by`,`create_time`,`update_time`) values (11,'全栈开发','',2,NULL,'admin','2019-03-31 13:39:30','2021-07-31 11:46:52');
insert  into `sys_job`(`id`,`name`,`enabled`,`sort`,`create_by`,`update_by`,`create_time`,`update_time`) values (12,'软件测试','',5,NULL,'admin','2019-03-31 13:39:43','2021-07-24 14:44:49');
insert  into `sys_job`(`id`,`name`,`enabled`,`sort`,`create_by`,`update_by`,`create_time`,`update_time`) values (16,'岗位','\0',33,'demo','demo','2021-07-23 22:24:56','2021-07-23 22:36:09');
insert  into `sys_job`(`id`,`name`,`enabled`,`sort`,`create_by`,`update_by`,`create_time`,`update_time`) values (18,'大大撒','',10,'admin','admin','2021-07-24 15:21:16','2021-07-24 15:21:16');

/*Data for the table `sys_menu` */

insert  into `sys_menu`(`id`,`pid`,`sub_count`,`type`,`title`,`title_letter`,`component_name`,`component`,`sort`,`icon`,`path`,`i_frame`,`cache`,`hidden`,`permission`,`create_by`,`update_by`,`create_time`,`update_time`) values (1,NULL,7,0,'系统管理','xtgl',NULL,NULL,900,'how_to_reg','system','\0','\0','\0',NULL,NULL,'admin','2021-07-25 18:06:41','2021-07-25 18:06:41');
insert  into `sys_menu`(`id`,`pid`,`sub_count`,`type`,`title`,`title_letter`,`component_name`,`component`,`sort`,`icon`,`path`,`i_frame`,`cache`,`hidden`,`permission`,`create_by`,`update_by`,`create_time`,`update_time`) values (2,1,4,1,'用户管理','yhgl','User','system/user/index',2,'people_alt','user','\0','','\0','user:list',NULL,'admin','2021-06-24 18:05:54','2021-07-24 08:09:33');
...
insert  into `sys_menu`(`id`,`pid`,`sub_count`,`type`,`title`,`title_letter`,`component_name`,`component`,`sort`,`icon`,`path`,`i_frame`,`cache`,`hidden`,`permission`,`create_by`,`update_by`,`create_time`,`update_time`) values (6,NULL,5,0,'系统监控','系统监控',NULL,NULL,935,'monitor','monitor','\0','\0','\0',NULL,NULL,'admin','2021-08-22 07:43:47','2021-08-24 22:24:40');
...
insert  into `sys_menu`(`id`,`pid`,`sub_count`,`type`,`title`,`title_letter`,`component_name`,`component`,`sort`,`icon`,`path`,`i_frame`,`cache`,`hidden`,`permission`,`create_by`,`update_by`,`create_time`,`update_time`) values (9,6,0,1,'SQL监控','SQLjk','Sql','monitor/sql/index',18,' ','druid','\0','\0','\0',NULL,NULL,'admin','2018-12-18 15:19:34','2021-08-22 07:43:48');
...
insert  into `sys_menu`(`id`,`pid`,`sub_count`,`type`,`title`,`title_letter`,`component_name`,`component`,`sort`,`icon`,`path`,`i_frame`,`cache`,`hidden`,`permission`,`create_by`,`update_by`,`create_time`,`update_time`) values (21,NULL,2,0,'多级菜单','djcd',NULL,'',945,'menu','nested','\0','\0','\0',NULL,NULL,'admin','2019-01-04 16:22:03','2021-07-24 08:59:19');
...
insert  into `sys_menu`(`id`,`pid`,`sub_count`,`type`,`title`,`title_letter`,`component_name`,`component`,`sort`,`icon`,`path`,`i_frame`,`cache`,`hidden`,`permission`,`create_by`,`update_by`,`create_time`,`update_time`) values (28,1,4,1,'任务调度','rwtd','Timing','system/timing/index',999,'today','timing','\0','\0','\0','timing:list',NULL,'admin','2021-06-24 18:07:47','2021-07-25 18:02:27');
...
insert  into `sys_menu`(`id`,`pid`,`sub_count`,`type`,`title`,`title_letter`,`component_name`,`component`,`sort`,`icon`,`path`,`i_frame`,`cache`,`hidden`,`permission`,`create_by`,`update_by`,`create_time`,`update_time`) values (36,NULL,7,0,'系统工具','xtgj',NULL,'',930,'build','sys-tools','\0','\0','\0',NULL,NULL,'admin','2019-03-29 10:57:35','2021-07-24 18:55:16');
insert  into `sys_menu`(`id`,`pid`,`sub_count`,`type`,`title`,`title_letter`,`component_name`,`component`,`sort`,`icon`,`path`,`i_frame`,`cache`,`hidden`,`permission`,`create_by`,`update_by`,`create_time`,`update_time`) values (37,1,4,1,'岗位管理','gwgl','Job','system/job/index',7,'monetization_on','job','\0','','\0','job:list',NULL,'admin','2021-06-24 18:07:14','2021-07-25 18:06:41');
...
insert  into `sys_menu`(`id`,`pid`,`sub_count`,`type`,`title`,`title_letter`,`component_name`,`component`,`sort`,`icon`,`path`,`i_frame`,`cache`,`hidden`,`permission`,`create_by`,`update_by`,`create_time`,`update_time`) values (39,1,4,1,'字典管理','zdgl','Dict','system/dict/index',8,'translate','dict','\0','','\0','dict:list',NULL,'admin','2021-06-24 18:07:33','2021-07-25 18:06:00');
...
insert  into `sys_menu`(`id`,`pid`,`sub_count`,`type`,`title`,`title_letter`,`component_name`,`component`,`sort`,`icon`,`path`,`i_frame`,`cache`,`hidden`,`permission`,`create_by`,`update_by`,`create_time`,`update_time`) values (80,6,0,1,'服务监控','fwjk','ServerMonitor','monitor/server/index',14,' ','server','\0','\0','\0','monitor:list',NULL,'admin','2019-11-07 13:06:39','2021-08-22 07:43:44');
...
insert  into `sys_menu`(`id`,`pid`,`sub_count`,`type`,`title`,`title_letter`,`component_name`,`component`,`sort`,`icon`,`path`,`i_frame`,`cache`,`hidden`,`permission`,`create_by`,`update_by`,`create_time`,`update_time`) values (121,NULL,1,0,'自动生成CRUD',NULL,NULL,NULL,10,'gavel','testtest','\0','','\0',NULL,'admin','admin','2021-08-25 21:04:46','2021-08-25 21:04:47');
insert  into `sys_menu`(`id`,`pid`,`sub_count`,`type`,`title`,`title_letter`,`component_name`,`component`,`sort`,`icon`,`path`,`i_frame`,`cache`,`hidden`,`permission`,`create_by`,`update_by`,`create_time`,`update_time`) values (153,121,4,1,'演示','ys','TestPerson','test-person/test/index',10,' ','test-person','\0','','\0','testPerson:list',NULL,'admin','2021-06-24 20:00:53','2021-08-25 21:04:47');
...
insert  into `sys_quartz_job`(`id`,`bean_name`,`cron_expression`,`is_pause`,`job_name`,`method_name`,`params`,`description`,`person_in_charge`,`email`,`sub_task`,`pause_after_failure`,`create_by`,`update_by`,`create_time`,`update_time`) values (2,'testTask','0/5 * * * * ?','','测试1','run1','test','带参测试，多参使用json，如果不能用那个多的参数的话，可能会有其他的问题','测试',NULL,NULL,'\0',NULL,'admin','2019-08-22 14:08:29','2021-07-31 12:08:21');
insert  into `sys_quartz_job`(`id`,`bean_name`,`cron_expression`,`is_pause`,`job_name`,`method_name`,`params`,`description`,`person_in_charge`,`email`,`sub_task`,`pause_after_failure`,`create_by`,`update_by`,`create_time`,`update_time`) values (3,'testTask','0/5 * * * * ?','','测试','run','','不带参测试','Zheng Jie','','5,6','',NULL,'admin','2019-09-26 16:44:39','2021-07-31 13:03:04');
...
insert  into `sys_role`(`id`,`name`,`name_letter`,`level`,`description`,`data_scope`,`create_by`,`update_by`,`create_time`,`update_time`) values (6,'test3','test3',3,NULL,'全部','admin','admin','2021-01-06 22:44:35','2021-08-20 21:59:55');
...
insert  into `sys_user`(`id`,`username`,`username_letter`,`nick_name`,`gender`,`phone`,`email`,`avatar_name`,`avatar_path`,`password`,`is_admin`,`enabled`,`create_by`,`update_by`,`pwd_reset_time`,`create_time`,`update_time`) values (1,'admin','admin','admin','男','18888888888','201507802','avatar-2021010504071782.png','C:\\coadmin\\avatar\\avatar-2021010504071782.png','$2a$10$teIV/KA8s2lqN/Gaiqxnm.dK5d8Ld/mH/NYtMGQVIF3Yhb/xrAif2','','','admin','admin','2021-01-05 16:09:45','2018-08-23 09:11:56','2021-01-05 16:09:45');
insert  into `sys_user`(`id`,`username`,`username_letter`,`nick_name`,`gender`,`phone`,`email`,`avatar_name`,`avatar_path`,`password`,`is_admin`,`enabled`,`create_by`,`update_by`,`pwd_reset_time`,`create_time`,`update_time`) values (4,'jinjin','jinjin','吕进华','男','13800138002','jinjin@gmail.com','avatar-20201011111043576.png','C:\\coadmin\\avatar\\avatar-20201011111043576.png','$2a$10$vklJaXZ6mUbYc9ulI0uuVOUVUHBr/49l7jYifZdXadLM84cdh9Qjm','\0','','admin','admin',NULL,'2020-09-26 17:19:53','2021-06-24 18:00:06');
insert  into `sys_user`(`id`,`username`,`username_letter`,`nick_name`,`gender`,`phone`,`email`,`avatar_name`,`avatar_path`,`password`,`is_admin`,`enabled`,`create_by`,`update_by`,`pwd_reset_time`,`create_time`,`update_time`) values (1314466299762499585,'t2','t2','t2','男','13800138005','t2@x.cn','avatar-20201009075909548.png','C:\\coadmin\\avatar\\avatar-20201009075909548.png','$2a$10$b6n6SGp25vFOHfsJnOgnBO8EsrZBzvToVGDO/SZVHTG0ySGq4n3sm','\0','','admin','admin','2020-10-09 08:00:22','2020-10-09 15:22:42','2021-07-30 23:49:12');
insert  into `sys_user`(`id`,`username`,`username_letter`,`nick_name`,`gender`,`phone`,`email`,`avatar_name`,`avatar_path`,`password`,`is_admin`,`enabled`,`create_by`,`update_by`,`pwd_reset_time`,`create_time`,`update_time`) values (1314466586531258369,'t3','t3','t3','女','18618343102','t3@x.cn','avatar-20201012121236789.png','C:\\coadmin\\avatar\\avatar-20201012121236789.png','$2a$10$e.q6ThYOxMpiwnjEdtcoDeRnD5mb6Sa9AJLJvnn.ZffsVRWLB5Q8W','\0','','admin','t3','2020-10-09 08:00:22','2020-10-09 15:23:50','2020-10-12 12:12:37');
insert  into `sys_user`(`id`,`username`,`username_letter`,`nick_name`,`gender`,`phone`,`email`,`avatar_name`,`avatar_path`,`password`,`is_admin`,`enabled`,`create_by`,`update_by`,`pwd_reset_time`,`create_time`,`update_time`) values (1314466748175540225,'t4','t4','t4','男','13800138004','t4@x.cn',NULL,NULL,'$2a$10$b4hTCxWIx8wbIycOCSTshO5eEioJayafiKPmcuWglHhgcpuK0Bd7q','\0','','admin','admin',NULL,'2020-10-09 15:24:29','2021-08-15 09:42:43');
insert  into `sys_user`(`id`,`username`,`username_letter`,`nick_name`,`gender`,`phone`,`email`,`avatar_name`,`avatar_path`,`password`,`is_admin`,`enabled`,`create_by`,`update_by`,`pwd_reset_time`,`create_time`,`update_time`) values (1314467243212464130,'t5','t5','t5','男','13800138003','t5@x.cn','avatar-20201009075909548.png','C:\\coadmin\\avatar\\avatar-20201009075909548.png','$2a$10$r6I/dwhJBpFKsldIJU10Y.xTzuBqBGqIgCAbmK8og7ABJMXuzUtba','\0','\0','admin','admin','2020-10-09 08:00:22','2020-10-09 15:26:27','2021-08-15 09:42:50');
insert  into `sys_user`(`id`,`username`,`username_letter`,`nick_name`,`gender`,`phone`,`email`,`avatar_name`,`avatar_path`,`password`,`is_admin`,`enabled`,`create_by`,`update_by`,`pwd_reset_time`,`create_time`,`update_time`) values (1325012704440709121,'西南用户1','xnyh1','西南用户1','女','13800138012',NULL,'avatar-20201009075909548.png','C:\\coadmin\\avatar\\avatar-20201009075909548.png','$2a$10$Rp9avpKzep/E7w/OFZ/6g.e0ZiTimHvm.aJenrwtCFC7l4R6rKaoO','\0','','admin','admin','2020-10-09 08:00:22','2020-11-07 17:50:21','2021-08-15 09:42:09');
insert  into `sys_user`(`id`,`username`,`username_letter`,`nick_name`,`gender`,`phone`,`email`,`avatar_name`,`avatar_path`,`password`,`is_admin`,`enabled`,`create_by`,`update_by`,`pwd_reset_time`,`create_time`,`update_time`) values (1345721913572020225,'demo','demo',NULL,'女',NULL,NULL,'avatar-20201009075909548.png','C:\\coadmin\\avatar\\avatar-20201009075909548.png','$2a$10$FwiQUYoJ.mpgSOtrB9gHqezgF8.9wPqGq8ImPc3/VZM6UR0DD4QEy','\0','\0','admin','admin','2020-10-09 08:00:22','2021-01-03 21:21:21','2021-08-25 20:54:43');
insert  into `sys_user`(`id`,`username`,`username_letter`,`nick_name`,`gender`,`phone`,`email`,`avatar_name`,`avatar_path`,`password`,`is_admin`,`enabled`,`create_by`,`update_by`,`pwd_reset_time`,`create_time`,`update_time`) values (1408020940352172033,'哈哈','hh',NULL,'男',NULL,NULL,NULL,NULL,'$2a$10$NCfkdiMm7z5tgEaQxSBNLuua73aqSa0ONUXgcAGl6wJioeb4GWbIm','\0','','demo','admin',NULL,'2021-06-24 19:15:27','2021-08-25 20:55:01');
...
insert  into `sys_users_depts`(`user_id`,`dept_id`) values (1314466748175540225,49);
...
insert  into `sys_users_jobs`(`user_id`,`job_id`) values (1314466299762499585,10);
insert  into `sys_users_jobs`(`user_id`,`job_id`) values (1314466299762499585,11);
insert  into `sys_users_jobs`(`user_id`,`job_id`) values (1314466299762499585,12);
insert  into `sys_users_jobs`(`user_id`,`job_id`) values (1314466299762499585,18);
insert  into `sys_users_jobs`(`user_id`,`job_id`) values (1314466586531258369,11);
insert  into `sys_users_jobs`(`user_id`,`job_id`) values (1314466748175540225,8);
insert  into `sys_users_jobs`(`user_id`,`job_id`) values (1314466748175540225,10);
...
insert  into `sys_users_jobs`(`user_id`,`job_id`) values (1408020940352172033,10);
insert  into `sys_users_jobs`(`user_id`,`job_id`) values (1408020940352172033,11);
insert  into `sys_users_jobs`(`user_id`,`job_id`) values (1408020940352172033,12);
...
insert  into `sys_users_roles`(`user_id`,`role_id`) values (1314466299762499585,1);
insert  into `sys_users_roles`(`user_id`,`role_id`) values (1408020940352172033,1);
insert  into `sys_users_roles`(`user_id`,`role_id`) values (1314466299762499585,2);
insert  into `sys_users_roles`(`user_id`,`role_id`) values (1314466586531258369,2);
insert  into `sys_users_roles`(`user_id`,`role_id`) values (1314466748175540225,2);
...
insert  into `sys_users_roles`(`user_id`,`role_id`) values (1408020940352172033,3);
insert  into `sys_users_roles`(`user_id`,`role_id`) values (1314466299762499585,4);
insert  into `sys_users_roles`(`user_id`,`role_id`) values (1325012704440709121,4);
insert  into `sys_users_roles`(`user_id`,`role_id`) values (1408020940352172033,4);
insert  into `sys_users_roles`(`user_id`,`role_id`) values (1314466299762499585,5);
insert  into `sys_users_roles`(`user_id`,`role_id`) values (1408020940352172033,5);
insert  into `sys_users_roles`(`user_id`,`role_id`) values (1314466299762499585,6);
insert  into `sys_users_roles`(`user_id`,`role_id`) values (1408020940352172033,6);

/*Data for the table `test_person` */

insert  into `test_person`(`id`,`name`,`gender`,`birthday`,`mysql_engine`,`create_time`,`create_by`,`update_time`,`update_by`,`remarks`) values (1419195907637448706,'你倒是','男','2020-07-01',30,'2021-07-25 15:20:46',NULL,'2021-08-22 10:12:39','admin','无');
insert  into `test_person`(`id`,`name`,`gender`,`birthday`,`mysql_engine`,`create_time`,`create_by`,`update_time`,`update_by`,`remarks`) values (1429265607297781761,'测试','男','2021-08-04',10,'2021-08-22 10:14:10','admin',NULL,NULL,'对对对');
insert  into `test_person`(`id`,`name`,`gender`,`birthday`,`mysql_engine`,`create_time`,`create_by`,`update_time`,`update_by`,`remarks`) values (1429267665325281282,'女生','女','2021-08-06',20,'2021-08-22 10:22:21',NULL,'2021-08-22 10:26:33','admin','好好');
